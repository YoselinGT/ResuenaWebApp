...
from src.api.admin_generos import router as admin_generos_router
...
from src.api.campanas import router as campanas_router
from src.api.generos_public import router as generos_public_router
from src.api.profesionales_busqueda import router as profesionales_busqueda_router
...
api_router.include_router(campanas_router)
api_router.include_router(profesionales_busqueda_router)
api_router.include_router(generos_public_router)
api_router.include_router(admin_generos_router)
